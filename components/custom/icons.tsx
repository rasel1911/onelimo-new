...
export const ConciergeIcon = ({ size = 16 }: { size?: number }) => {
	return (
		<svg
			height={size}
			width={size}
			viewBox="0 0 31.082 31.082"
			strokeLinejoin="round"
		...
		>
			<g fill="currentColor">
				...
				<path
					d="M25.357,17.068h0.246c1.198,0,2.169-0.973,2.169-2.17v-2.387c0-0.825-0.461-1.542-1.137-1.91
